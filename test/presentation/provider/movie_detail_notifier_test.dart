...
void main() {
  ...
  group('Watchlist', () {
    test('should get the watchlist status', () async {
      // arrange
      when(mockGetWatchlistStatusMovie.execute(1)).thenAnswer((_) async => true);
      // act
    ...
    test(
      ...
      () async {
        // arrange
        when(mockRemoveWatchlistMovie.execute(testMovieDetail)).thenAnswer((_) async => Left(ServerFailure('Server Failure')));
